...
var is0_AK_constants = {is0_Ka_atp, is0_Kb_mg_atp, is0_Kb_mg_hatp, 
                        is0_Ka_adp, is0_Kb_mg_adp, is0_Kb_mg_hadp,
                        is0_Ka_amp, is0_Kb_mg_amp};

// Make the object a map as it will be iterated through 
var is0_AK_constants = new Map(Object.entries(is0_AK_constants));
//-------------------------------------------------------------------//
...
function calcAK_Keq_steps(ionicStrength, temp25, tempK, AK_kref, proton, freeMg) {
    ...
    // iterate through the acid and Mg-binding Krefs in the AK Eq reaction
    for(var [key, value] of is0_AK_constants) {
    ...
    var eq_num_amp = 1 + (proton/new_Kabs.get('Ka_amp')) + (new_Kabs.get('Kb_mg_amp')*freeMg);
    ...
    Keq_AK.push((AK_kref * eq_num_atp * eq_num_amp) / (eq_den_adp * eq_den_adp));
...
function startCalc(param){
    ...
    //**************Adenylate Kinase Steps************************//
    
    // Adjust the Kref of AK @ I=0, T=25°C to tempK
    var Kref_AK_newT_is0 = vant_hoff(temp25, tempK, is0_Kref_AK.kref, is0_Kref_AK.dH);
    
    // Adjust the Kref of AK @ I=0, T=tempK to Ionic Strength of assay
    var Kref_AK_adj = Kref_AK_newT_is0/solve_gamma(is0_Kref_AK.prod, is0_Kref_AK.react, tempK, ionicStrength);
    
    /* Adjust the Kb and Ka values of the AK eq. reaction 
       and multiply them by the adjusted AK Krefs to calculate
       the AK Keq 
    */
    // The Modified AK Eq. Constant
    var Keq_AK = calcAK_Keq_steps(ionicStrength, temp25, tempK, Kref_AK_adj, proton, freeMg);

    
    generate_output(Keq_AK);
};